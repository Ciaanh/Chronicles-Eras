...
addon.descName = L["Chronicles - Eras"]
addon.description = L["Add Azeroth history eras to Chronicles' timeline"]
addon.pluginName = L["Eras"]
...
DB = {
	...
	[1] = {
		...
		description = L["Black Empire description"],
		icon = "research",
		yearStart = -7000,
		yearEnd = -6500,
